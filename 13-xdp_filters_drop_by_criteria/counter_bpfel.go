...
const (
	counterMapBlockedPorts = "blocked_ports"
	counterMapPortCount    = "port_count"
	counterProgCountByPort = "count_by_port"
)
...
type counterProgramSpecs struct {
	CountByPort *ebpf.ProgramSpec `ebpf:"count_by_port"`
}
...
type counterPrograms struct {
	CountByPort *ebpf.Program `ebpf:"count_by_port"`
}
