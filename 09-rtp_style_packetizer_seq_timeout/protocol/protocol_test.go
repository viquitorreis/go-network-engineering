...
func TestRTPDatagram_ToDatagram_ZeroValues(t *testing.T) {
	original := RTPDatagram{SeqNumber: 0, Payload: 0, Timestamp: 0}
...
func TestRTPDatagram_ToDatagram_MaxValues(t *testing.T) {
	original := RTPDatagram{
...
func TestRTPDatagram_DifferentSeqNumbers_ProduceDifferentDatagrams(t *testing.T) {
	a := RTPDatagram{SeqNumber: 1, Payload: 100, Timestamp: 1000}
	b := RTPDatagram{SeqNumber: 2, Payload: 100, Timestamp: 1000}
