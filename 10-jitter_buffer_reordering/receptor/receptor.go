...
func (r *Receptor) handleRead() {
	for {
		...
		// every packet that arises needs to pass throught the JitterBuffer
		// its the buffer who decides the liberation order of packets based on timestamp, not the receptor itself
		packet := &Packet{
